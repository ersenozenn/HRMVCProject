        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReplyState = table.Column<int>(type: "int", nullable: false),
                    AdressToGo = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "5e302669-58fe-4513-8831-782b246a14b6", "Admin", "ADMIN" },
                    { 2, "8e080373-0248-4cc5-a41a-e2162ccc7a42", "Manager", "MANAGER" },
                    { 1, "4498bdcc-43b1-4f92-a702-756415a6cb3b", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "e6744b00-2cee-405b-bde9-977f474f2153", "4d1e7ba2-bdf1-4ed1-9ea6-cdd419101860", "User", "USER" },
                    { "c83e7200-1b48-4f77-83e9-0ae92d94250d", "b35ff99b-444d-40af-b566-84a2cb5b6fc3", "Admin", "ADMIN" },
                    { "f44ffb98-fbe8-4830-af0b-0d48bd3013b0", "ea6dfe62-3e85-42d2-b9de-3f7e38d04d5b", "Manager", "MANAGER" }
                });
